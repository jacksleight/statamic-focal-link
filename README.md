...
This Statamic addon provides foolproof fragment identifier linking via automatic ID discovery, common format templates and predefined options. Also supports manual input and query strings.
